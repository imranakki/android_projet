...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noteActivityLauncher = registerForActivityResult(
                ...
                result -> {
                    if (result.getResultCode() == RESULT_OK && result.getData() != null) {
                        ...
                        String matiere = data.getStringExtra(NoteActivity.RESULT_NOTE_MATIERE);
                        double score   = data.getDoubleExtra(NoteActivity.RESULT_NOTE_SCORE, 0);
        ...
        buttonEnregistrer.setOnClickListener(v -> {
            StorageHelper.saveProfile(this,
        ...
        buttonAddNote.setOnClickListener(v -> {
            ...
            intent.putExtra(NoteActivity.EXTRA_STUDENT_NAME,
                    editTextNom.getText().toString().trim()
                    + " " + editTextPrenom.getText().toString().trim());
            noteActivityLauncher.launch(intent);
        });

        buttonVoirNotes.setOnClickListener(v -> {
            Intent intent = new Intent(this, NotesViewerActivity.class);
            intent.putExtra(NotesViewerActivity.EXTRA_STUDENT_NAME,
                    editTextNom.getText().toString().trim()
                    + " " + editTextPrenom.getText().toString().trim());
        ...
        JsonObjectRequest request = new JsonObjectRequest(
                ...
                response -> {
                    try {
                        ...
                        com.android.volley.toolbox.ImageRequest imgRequest = new com.android.volley.toolbox.ImageRequest(photoUrl,
                                bitmap -> {
                                ...
                                0, 0, android.widget.ImageView.ScaleType.FIT_CENTER, null,
                                error -> android.util.Log.e("Image", "Failed to load image")
                        );
                        VolleySingleton.getInstance(MainActivity.this).getRequestQueue().add(imgRequest);
                ...
                error -> Toast.makeText(this, R.string.toast_network_error, Toast.LENGTH_SHORT).show()
        );
